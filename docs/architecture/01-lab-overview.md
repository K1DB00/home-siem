...
- **VMnet8 (NAT)** — provides outbound internet access for OS and package updates on lab VMs. It is DHCP-managed and treated as temporary and non-authoritative; see `02-network-topology.md`, Section 13, for implementation notes on VMware's networking behavior.
